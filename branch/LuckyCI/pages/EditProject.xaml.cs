                        ...
                        if (projectInfo.Statusproperty == "true")
                        {
                          ...
                          //  测试用的语句
                           if (updateResult)
                            ...
                            {
                                    SendMailSlack sendMailSlack = new SendMailSlack(projectInfoGetLocal, null, updateLog, xmlPath);
                            ...
                            else
                            {
                                ...
                                //编译项目                                                                       
                                ProjectInfo buildFinishedInfo = BuildProject(projectInfoGetLocal);
                                //存储编译信息
